...
//? Redirect
app.get('/redirect-per', (req, res) => res.redirect(301, 'https://www.google.com')); // permanantly
app.get('/redirect-temp', (req, res) => res.redirect(302, 'https://www.clarusway.com')); // temproaryly


/* ------------------------------------------------------- */
//? Express run server 
app.listen(PORT, HOST, () => console.log('Running at: http://127.0.0.1:' + PORT));