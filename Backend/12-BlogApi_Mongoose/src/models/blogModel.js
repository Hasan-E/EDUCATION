...
const nameSchema = new mongoose.Schema({
    ...
    fieldName3:{
        ...
        get: ()=>{return data},// it works default when we read operation 
        set: ()=>{return data},// it works default when we creat or update operations
...
// mongoose.model('ModelName',nameShema);
